@echo off
rem ===========================================================================
rem  fnOS (FeiNiu) fpk builder for the Intelligent Class Allocation System
...
set "PROJ=%~dp0"
set "FNOS=%PROJ%fnos"
set "PKG=%FNOS%\intelligent-allocation"
set "SERVER=%PKG%\app\server"

echo === Build fnOS fpk: Intelligent Class Allocation System ===
echo.
...
set "APPNAME=%APPNAME: =%"
set "VERSION=%VERSION: =%"
if not defined APPNAME set "APPNAME=intelligent-allocation"
